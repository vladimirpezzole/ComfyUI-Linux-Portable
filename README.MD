...
**Para incializar execute o scrip `run-auto.sh` , escolha entre usar GPU NVIDEA, AMD ou CPU:**
...
**ou utilize o scrip 'run' mais adequado ao seu uso >> mais informações veja a seção:**
